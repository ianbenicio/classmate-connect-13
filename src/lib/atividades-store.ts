...
function atividadeToRow(a: Atividade) {
  return {
    ...
    habilidade_ids: toUuidArray(a.habilidadeIds) as unknown as object,
    ...
    niveis_alvo: (a.niveisAlvo ?? []) as unknown as object,
    criterios_sucesso: a.criteriosSucesso ?? null,
    metodologias: a.metodologias ?? null,
    roteiro: (a.roteiro ?? []) as unknown as object,
    materiais: (a.materiais ?? []) as unknown as object,
    referencias: a.referencias ?? null,
    formularios: (a.formularios ?? null) as unknown as object | null,
    rubricas: (a.rubricas ?? []) as unknown as object,
